...
export { MockSchemaRegistry } from './src/mock/schema_registry_mock';
export { MockLocationStrategy } from './src/mock/mock_location_strategy';
export { SpyLocation } from './src/mock/location_mock';
