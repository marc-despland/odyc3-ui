...
var TestComponentBuilder = (function () {
    ...
    TestComponentBuilder.prototype.createAsync = function (rootComponentType) {
        ...
        var doc = this._injector.get(platform_browser_1.DOCUMENT);
        // TODO(juliemr): can/should this be optional?
        var oldRoots = platform_browser_private_1.getDOM().querySelectorAll(doc, '[id^=root]');
        for (var i = 0; i < oldRoots.length; i++) {
            platform_browser_private_1.getDOM().remove(oldRoots[i]);
        }
        platform_browser_private_1.getDOM().appendChild(doc.body, rootEl);
